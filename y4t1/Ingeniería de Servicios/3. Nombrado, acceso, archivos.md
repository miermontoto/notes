...
- Servidores de nombres (`named`) ← complejos
...
Una zona puede tener varios NS → redundancia, seguridad y balanceo de carga.
...
- A petición de un programa, conecta con el SN y hace una consulta.
